...
import { authLogin } from "@/admin/store";
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-royal-950 via-royal-900 to-royal-800 px-4">
      ...
      >
        <div className="text-center">
          ...
          <p className="font-heading text-xs tracking-[0.2em] text-gold-300 uppercase">
            Cantt, Guna · Admin Panel
          </p>
        </div>
        ...
        <div className="mt-8 space-y-4">
          <label className="block">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-royal-100/60 transition hover:text-gold-300"
              >
          ...
          {error && (
            <motion.p initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="font-body text-xs text-red-300">
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-gold-400 to-gold-300 px-5 py-3.5 font-heading font-semibold text-royal-900 transition hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-50"
          >
        ...
        <p className="mt-6 text-center font-body text-[0.7rem] text-royal-100/40">
